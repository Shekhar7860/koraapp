...
class AutoTagsView extends Component {
        ...
        {contactData.map((user) => {
          return (
            <TouchableHighlight
              ...
              onPress={() => this.props.handleDelete(user)}>
              <Text style={{color: '#07377F', fontSize: normalize(12)}}>
                {user.fN + ' ' + user.lN} &nbsp;&#x2715;
              </Text>
            </TouchableHighlight>
          );
          ...
          <ScrollView
            ...
            <View
              ...
              <TextInput
                ...
                placeholder={'Type and select people'}></TextInput>
            </View>
          </ScrollView>
        </View>
      ...
      <TouchableHighlight
        ...
        <>
          <View
            ...
            <View
              style={{flexDirection: 'column', marginStart: 15, padding: 5}}>
  ...
  renderSuggestionList() {
    ...
    //  console.log("suggestion----",this.props.suggestions);
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        {this.state.inputFocus && <View>{this.renderSuggestionList()}</View>}
      </>
      // <View style={{flex: 1}}>
