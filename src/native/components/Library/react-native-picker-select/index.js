...
import { Keyboard, Modal, Platform, Text, TextInput, TouchableOpacity, View, Picker} from 'react-native';
...
export default class RNPickerSelect extends PureComponent {
    ...
    static getSelectedItem({ items, key, value }) {
        ...
        return {
            selectedItem: items[idx] || emptyObject,
            idx,
        };
    }
        ...
        return (
            <View pointerEvents="box-only" style={containerStyle}>
                <TextInput
                    testID="text_input"
                    style={[
                        Platform.OS === 'ios' ? customPickerStyles.inputIOS : customPickerStyles.inputAndroid,
