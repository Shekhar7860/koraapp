...
public class CustomPushNotificationPicturesAggregator  {
   public interface Callback {
    ...
    public CustomPushNotificationPicturesAggregator(Callback callback) {
    ...
    public void setBigPictureUrl(Context context, String url) {
        ...
        final CustomPushNotificationPicturesAggregator aggregator = this;
